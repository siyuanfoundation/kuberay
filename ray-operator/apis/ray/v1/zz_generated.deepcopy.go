...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HeadBackupRestoreSpec) DeepCopyInto(out *HeadBackupRestoreSpec) {
	*out = *in
	if in.Enable != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HeadBackupRestoreSpec.
func (in *HeadBackupRestoreSpec) DeepCopy() *HeadBackupRestoreSpec {
	if in == nil {
		return nil
	}
	out := new(HeadBackupRestoreSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HeadGroupSpec) DeepCopyInto(out *HeadGroupSpec) {
	*out = *in
	...
	if in.HeadBackupRestore != nil {
		in, out := &in.HeadBackupRestore, &out.HeadBackupRestore
		*out = new(HeadBackupRestoreSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *RayClusterStatus) DeepCopyInto(out *RayClusterStatus) {
	*out = *in
	...
	if in.LastPodSnapshotTime != nil {
		in, out := &in.LastPodSnapshotTime, &out.LastPodSnapshotTime
		*out = (*in).DeepCopy()
	}
